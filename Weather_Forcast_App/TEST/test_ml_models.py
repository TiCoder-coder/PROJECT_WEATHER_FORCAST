...
def test_random_forest():
    ...
    from Weather_Forcast_App.Models.Random_Forest_Model import WeatherRandomForest
...
def test_catboost():
    ...
    try:
        from Weather_Forcast_App.Models.CatBoost_Model import WeatherCatBoost, CATBOOST_AVAILABLE
